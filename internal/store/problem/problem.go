...
const (
	...
	// FieldResolveAt holds the string denoting the resolve_at field in the database.
	FieldResolveAt = "resolve_at"
...
// ByResolveAt orders the results by the resolve_at field.
func ByResolveAt(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldResolveAt, opts...).ToFunc()
}
