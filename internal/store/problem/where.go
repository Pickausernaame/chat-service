...
// ResolveAt applies equality check predicate on the "resolve_at" field. It's identical to ResolveAtEQ.
func ResolveAt(v time.Time) predicate.Problem {
	return predicate.Problem(sql.FieldEQ(FieldResolveAt, v))
}
...
// ResolveAtEQ applies the EQ predicate on the "resolve_at" field.
func ResolveAtEQ(v time.Time) predicate.Problem {
	return predicate.Problem(sql.FieldEQ(FieldResolveAt, v))
}

// ResolveAtNEQ applies the NEQ predicate on the "resolve_at" field.
func ResolveAtNEQ(v time.Time) predicate.Problem {
	return predicate.Problem(sql.FieldNEQ(FieldResolveAt, v))
}

// ResolveAtIn applies the In predicate on the "resolve_at" field.
func ResolveAtIn(vs ...time.Time) predicate.Problem {
	return predicate.Problem(sql.FieldIn(FieldResolveAt, vs...))
}

// ResolveAtNotIn applies the NotIn predicate on the "resolve_at" field.
func ResolveAtNotIn(vs ...time.Time) predicate.Problem {
	return predicate.Problem(sql.FieldNotIn(FieldResolveAt, vs...))
}

// ResolveAtGT applies the GT predicate on the "resolve_at" field.
func ResolveAtGT(v time.Time) predicate.Problem {
	return predicate.Problem(sql.FieldGT(FieldResolveAt, v))
}

// ResolveAtGTE applies the GTE predicate on the "resolve_at" field.
func ResolveAtGTE(v time.Time) predicate.Problem {
	return predicate.Problem(sql.FieldGTE(FieldResolveAt, v))
}

// ResolveAtLT applies the LT predicate on the "resolve_at" field.
func ResolveAtLT(v time.Time) predicate.Problem {
	return predicate.Problem(sql.FieldLT(FieldResolveAt, v))
}

// ResolveAtLTE applies the LTE predicate on the "resolve_at" field.
func ResolveAtLTE(v time.Time) predicate.Problem {
	return predicate.Problem(sql.FieldLTE(FieldResolveAt, v))
}

// ResolveAtIsNil applies the IsNil predicate on the "resolve_at" field.
func ResolveAtIsNil() predicate.Problem {
	return predicate.Problem(sql.FieldIsNull(FieldResolveAt))
}

// ResolveAtNotNil applies the NotNil predicate on the "resolve_at" field.
func ResolveAtNotNil() predicate.Problem {
	return predicate.Problem(sql.FieldNotNull(FieldResolveAt))
}
