...
func (pd *ProblemDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, ProblemMutation](ctx, pd.sqlExec, pd.mutation, pd.hooks)
}
...
func (pd *ProblemDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(problem.Table, sqlgraph.NewFieldSpec(problem.FieldID, field.TypeUUID))
