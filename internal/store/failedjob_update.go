...
func (fju *FailedJobUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, FailedJobMutation](ctx, fju.sqlSave, fju.mutation, fju.hooks)
}
...
func (fjuo *FailedJobUpdateOne) Save(ctx context.Context) (*FailedJob, error) {
	return withHooks[*FailedJob, FailedJobMutation](ctx, fjuo.sqlSave, fjuo.mutation, fjuo.hooks)
}
