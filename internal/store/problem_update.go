...
func (pu *ProblemUpdate) SetNillableResolveAt(t *time.Time) *ProblemUpdate {
	if t != nil {
		pu.SetResolveAt(*t)
	}
	return pu
...
func (pu *ProblemUpdate) ClearResolveAt() *ProblemUpdate {
	pu.mutation.ClearResolveAt()
	return pu
}
...
func (pu *ProblemUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if pu.mutation.ResolveAtCleared() {
		_spec.ClearField(problem.FieldResolveAt, field.TypeTime)
	}
...
// SetResolveAt sets the "resolve_at" field.
func (puo *ProblemUpdateOne) SetResolveAt(t time.Time) *ProblemUpdateOne {
	puo.mutation.SetResolveAt(t)
	return puo
}

// SetNillableResolveAt sets the "resolve_at" field if the given value is not nil.
func (puo *ProblemUpdateOne) SetNillableResolveAt(t *time.Time) *ProblemUpdateOne {
	if t != nil {
		puo.SetResolveAt(*t)
	}
	return puo
...
// ClearResolveAt clears the value of the "resolve_at" field.
func (puo *ProblemUpdateOne) ClearResolveAt() *ProblemUpdateOne {
	puo.mutation.ClearResolveAt()
	return puo
}
...
func (puo *ProblemUpdateOne) sqlSave(ctx context.Context) (_node *Problem, err error) {
	...
	if puo.mutation.ResolveAtCleared() {
		_spec.ClearField(problem.FieldResolveAt, field.TypeTime)
	}
