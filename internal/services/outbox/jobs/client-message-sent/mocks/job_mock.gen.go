...
// GetManagerIDByChatID mocks base method.
func (m *MockproblemRepository) GetManagerIDByChatID(ctx context.Context, chatID types.ChatID) (types.UserID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetManagerIDByChatID", ctx, chatID)
	ret0, _ := ret[0].(types.UserID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetManagerIDByChatID indicates an expected call of GetManagerIDByChatID.
func (mr *MockproblemRepositoryMockRecorder) GetManagerIDByChatID(ctx, chatID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetManagerIDByChatID", reflect.TypeOf((*MockproblemRepository)(nil).GetManagerIDByChatID), ctx, chatID)
}
