...
import (
	...
	afcverdictsprocessormocks "github.com/Pickausernaame/chat-service/internal/services/afc-verdicts-processor/mocks"
...
func (km kafkaMsgValueMatcher) Matches(x interface{}) bool {
